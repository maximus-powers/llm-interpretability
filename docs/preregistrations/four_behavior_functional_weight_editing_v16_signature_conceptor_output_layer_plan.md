# V16 Plan: Signature-Conditioned Conceptor Steering Compiled To Output-Layer Edits

Status: planning draft for reviewer approval. Do not implement, generate V16
pools, or run development until this plan is reviewed at 5/5 and converted into
