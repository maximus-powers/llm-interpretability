# V15 Preregistration: Signature-Conditioned Hypernetwork Functional Editing

Status: formal preregistration draft converted from the reviewer-approved V15
plan. Do not implement or run source pools until this formal preregistration is
reviewed at 5/5.
